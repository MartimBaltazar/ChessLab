...
export default function ImportFromLichessScreen() {
  ...
  useEffect(() => {
    navigation.setOptions({
      title: "Import From Lichess", // Set the header title
      headerStyle: {
  ...
  return (
    <BackgroundImage>
      <GreenButton title='Import From Lichess' onPress={doNothing} marginTop={70}></GreenButton>
    </BackgroundImage>
  );
}
